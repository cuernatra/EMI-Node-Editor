...
- `src/core/registry/nodes/nodeCompileHelpers.h`
    Reusable compile helpers (wrapper include). Use this first before touching compiler internals.
    (Implementation lives in `src/core/compiler/nodeCompileHelpers.h`.)
