...
EMI_REGISTER(getmousex,                getmousex_impl)
EMI_REGISTER(getmousey,                getmousey_impl)
EMI_REGISTER(ismousebuttondown,        ismousebuttondown_impl)
EMI_REGISTER(getpixel,                 getpixel_impl)
